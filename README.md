...
Модуль для сайта капсулы времени, зашифровывает капсулы, а также проверяет условия открытия
Для личного использования используется собранный в exe файл
Для размещения на сервере, зашифрованная информация хранится в БД
